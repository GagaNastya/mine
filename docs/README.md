...
|Технический персонал|Физические лица, которые занимаются трансляцией конференции в режиме реального времени для удаленных участников, а также за соблюдение|
...
rectangle "Участники конференции" as Participants
rectangle "Докладчики" as Speakers
rectangle "Рецензенты" as Reviewers
rectangle "Организаторы" as Organizers
rectangle "Модераторы" as Moderators
rectangle "Трансляторы" as Translators
rectangle "Спонсоры" as Sponsors
rectangle "Информационные ресурсы" as InformationResources
...
Organizers -- Sponsors
Organizers -- InformationResources
