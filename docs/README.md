...
# Бизнес-метрики
1. Количество поданных докладов – 1000
2. Количество просмотров одной трансляции конференции – 5000
...
|--------------------|--------------------------------|-----------|---------------------|------------------------|
|**Количество поданных докладов – 1000**|Система должна обеспечивать возможность одновременной обработки не менее 3 заявок на доклад в час, 71 заявки в день, 500 заявок в неделю|PRF.001|Производительность| Мониторинг нагрузки на веб-сервер и пропускной способности сети при трансляции конференции|
...
||Платформа для трансляции должна иметь масштабируемую архитектуру с использованием распределенных вычислительных систем и/или балансировщика нагрузки|SCL.001|Масштабируемость| Мониторинг нагрузки на серверах – генерировать тестовую нагрузку и анализировать показатели производительности и нагрузки на систему|
|||||Использовать инструменты для мониторинга и управления кластерами, такие как Kubernetes|
|**Количество просмотров одной трансляции конференции – 3000**| Пропускная способность интернет-канала должна быть не менее 75 Мбит/с|PRF.002|Производительность| Проведение тестов на пропускную способность|
